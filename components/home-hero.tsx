    ...
    <section className="relative bg-background">
      <div className="container mx-auto px-4 pt-24 pb-8 sm:pt-28 sm:pb-10 lg:pt-28 lg:pb-12">
        <div className="overflow-hidden rounded-2xl bg-card shadow-xl sm:rounded-3xl lg:grid lg:grid-cols-[minmax(0,1.2fr)_minmax(22.5rem,26.5rem)] lg:items-stretch">
          <div className="relative isolate min-h-[22rem] overflow-hidden sm:min-h-[26rem] lg:min-h-[40rem]">
            <picture className="absolute inset-0 block">
              ...
              <Image
                ...
                className="object-cover object-[52%_58%] sm:object-[54%_52%] lg:object-[48%_50%]"
              />
            </picture>

            {/* Text contrast on the copy side only — photo stays saturated. */}
            <div
              className="absolute inset-0 bg-gradient-to-b from-black/55 via-black/25 to-black/20 lg:bg-gradient-to-r lg:from-black/60 lg:via-black/30 lg:via-[42%] lg:to-transparent lg:to-[78%]"
              aria-hidden
            />
            {/* Soft white fade only toward the form edge. */}
            <div
              className="absolute inset-x-0 bottom-0 h-28 bg-gradient-to-b from-transparent to-card lg:inset-y-0 lg:left-auto lg:right-0 lg:h-auto lg:w-40 lg:bg-gradient-to-r xl:w-52"
              aria-hidden
            />

            <div className="relative z-10 flex h-full flex-col justify-start px-5 py-6 sm:px-8 sm:py-8 lg:px-10 lg:py-9 lg:pr-16 xl:px-12">
              <div className="max-w-xl space-y-4 text-white animate-fade-up lg:space-y-5">
                ...
                <p className="max-w-lg text-sm leading-relaxed text-white/88 drop-shadow-sm sm:text-base lg:text-lg">
                ...
                <ul className="max-w-md space-y-1 rounded-2xl border border-white/15 bg-black/40 p-3 backdrop-blur-md sm:p-4">
